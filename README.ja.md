...
- **[Unreleased]** — Compatibility audit of GJC v0.11.6–v0.11.9 against jeo-code; only jeo-native gaps are included here. The already-published `jeo-code@0.9.1` remains immutable and is verified separately.
