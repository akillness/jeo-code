...
test("chooseDefaultModel: blank → provider's recommended", () => {
  ...
  expect(chooseDefaultModel("   ", "anthropic").model).toBe("claude-3-5-sonnet");
});
